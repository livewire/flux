(()=>{var et=class extends Event{oldState;newState;constructor(t,{oldState:e="",newState:i="",...o}={}){super(t,o),this.oldState=String(e||""),this.newState=String(i||"")}},ci=new WeakMap;function di(t,e,i){ci.set(t,setTimeout(()=>{ci.has(t)&&t.dispatchEvent(new et("toggle",{cancelable:!1,oldState:e,newState:i}))},0))}var Ct=globalThis.ShadowRoot||function(){},po=globalThis.HTMLDialogElement||function(){},Xe=new WeakMap,j=new WeakMap,De=new WeakMap;function Ge(t){return De.get(t)||"hidden"}var Je=new WeakMap;function bo(t){let e=t.popoverTargetElement;if(!(e instanceof HTMLElement))return;let i=Ge(e);t.popoverTargetAction==="show"&&i==="showing"||t.popoverTargetAction==="hide"&&i==="hidden"||(i==="showing"?Re(e,!0,!0):ue(e,!1)&&(Je.set(e,t),_t(e)))}function ue(t,e){return!(t.popover!=="auto"&&t.popover!=="manual"||!t.isConnected||e&&Ge(t)!=="showing"||!e&&Ge(t)!=="hidden"||t instanceof po&&t.hasAttribute("open")||document.fullscreenElement===t)}function ui(t){return t?Array.from(j.get(t.ownerDocument)||[]).indexOf(t)+1:0}function mo(t){let e=bi(t),i=go(t);return ui(e)>ui(i)?e:i}function Qe(t){let e=j.get(t);for(let i of e||[])if(!i.isConnected)e.delete(i);else return i;return null}function ye(t){return typeof t.getRootNode=="function"?t.getRootNode():t.parentNode?ye(t.parentNode):t}function bi(t){for(;t;){if(t instanceof HTMLElement&&t.popover==="auto"&&De.get(t)==="showing")return t;if(t=t instanceof Element&&t.assignedSlot||t.parentElement||ye(t),t instanceof Ct&&(t=t.host),t instanceof Document)return}}function go(t){for(;t;){let e=t.popoverTargetElement;if(e instanceof HTMLElement)return e;if(t=t.parentElement||ye(t),t instanceof Ct&&(t=t.host),t instanceof Document)return}}function vo(t){let e=new Map,i=0;for(let s of j.get(t.ownerDocument)||[])e.set(s,i),i+=1;e.set(t,i),i+=1;let o=null;function n(s){let r=bi(s);if(r===null)return null;let c=e.get(r);(o===null||e.get(o)<c)&&(o=r)}return n(t.parentElement||ye(t)),o}function wo(t){return t.hidden||t instanceof Ct||(t instanceof HTMLButtonElement||t instanceof HTMLInputElement||t instanceof HTMLSelectElement||t instanceof HTMLTextAreaElement||t instanceof HTMLOptGroupElement||t instanceof HTMLOptionElement||t instanceof HTMLFieldSetElement)&&t.disabled||t instanceof HTMLInputElement&&t.type==="hidden"||t instanceof HTMLAnchorElement&&t.href===""?!1:typeof t.tabIndex=="number"&&t.tabIndex!==-1}function yo(t){if(t.shadowRoot&&t.shadowRoot.delegatesFocus!==!0)return null;let e=t;e.shadowRoot&&(e=e.shadowRoot);let i=e.querySelector("[autofocus]");if(i)return i;{let s=e.querySelectorAll("slot");for(let r of s){let c=r.assignedElements({flatten:!0});for(let a of c){if(a.hasAttribute("autofocus"))return a;if(i=a.querySelector("[autofocus]"),i)return i}}}let o=t.ownerDocument.createTreeWalker(e,NodeFilter.SHOW_ELEMENT),n=o.currentNode;for(;n;){if(wo(n))return n;n=o.nextNode()}}function Ao(t){yo(t)?.focus()}var Ze=new WeakMap;function _t(t){if(!ue(t,!1))return;let e=t.ownerDocument;if(!t.dispatchEvent(new et("beforetoggle",{cancelable:!0,oldState:"closed",newState:"open"}))||!ue(t,!1))return;let i=!1;if(t.popover==="auto"){let n=t.getAttribute("popover"),s=vo(t)||e;if(tt(s,!1,!0),n!==t.getAttribute("popover")||!ue(t,!1))return}Qe(e)||(i=!0),Ze.delete(t);let o=e.activeElement;t.classList.add(":popover-open"),De.set(t,"showing"),Xe.has(e)||Xe.set(e,new Set),Xe.get(e).add(t),Ao(t),t.popover==="auto"&&(j.has(e)||j.set(e,new Set),j.get(e).add(t),mi(Je.get(t),!0)),i&&o&&t.popover==="auto"&&Ze.set(t,o),di(t,"closed","open")}function Re(t,e=!1,i=!1){if(!ue(t,!0))return;let o=t.ownerDocument;if(t.popover==="auto"&&(tt(t,e,i),!ue(t,!0))||(mi(Je.get(t),!1),Je.delete(t),i&&(t.dispatchEvent(new et("beforetoggle",{oldState:"open",newState:"closed"})),!ue(t,!0))))return;Xe.get(o)?.delete(t),j.get(o)?.delete(t),t.classList.remove(":popover-open"),De.set(t,"hidden"),i&&di(t,"open","closed");let n=Ze.get(t);n&&(Ze.delete(t),e&&n.focus())}function fi(t,e=!1,i=!1){let o=Qe(t);for(;o;)Re(o,e,i),o=Qe(t)}function tt(t,e,i){let o=t.ownerDocument||t;if(t instanceof Document)return fi(o,e,i);let n=null,s=!1;for(let r of j.get(o)||[])if(r===t)s=!0;else if(s){n=r;break}if(!s)return fi(o,e,i);for(;n&&Ge(n)==="showing"&&j.get(o)?.size;)Re(n,e,i)}var St=new WeakMap;function hi(t){if(!t.isTrusted)return;let e=t.composedPath()[0];if(!e)return;let i=e.ownerDocument;if(!Qe(i))return;let n=mo(e);if(n&&t.type==="pointerdown")St.set(i,n);else if(t.type==="pointerup"){let s=St.get(i)===n;St.delete(i),s&&tt(n||i,!1,!0)}}var Et=new WeakMap;function mi(t,e=!1){if(!t)return;Et.has(t)||Et.set(t,t.getAttribute("aria-expanded"));let i=t.popoverTargetElement;if(i instanceof HTMLElement&&i.popover==="auto")t.setAttribute("aria-expanded",String(e));else{let o=Et.get(t);o?t.setAttribute("aria-expanded",o):t.removeAttribute("aria-expanded")}}var pi=globalThis.ShadowRoot||function(){};function xo(){return typeof HTMLElement<"u"&&typeof HTMLElement.prototype=="object"&&"popover"in HTMLElement.prototype}function ce(t,e,i){let o=t[e];Object.defineProperty(t,e,{value(n){return o.call(this,i(n))}})}var So=/(^|[^\\]):popover-open\b/g;function Eo(){return typeof globalThis.CSSLayerBlockRule=="function"}function ko(){let t=Eo();return`
...
${t?"}":""}
`}var we=null;function kt(t){let e=ko();if(we===null)try{we=new CSSStyleSheet,we.replaceSync(e)}catch{we=!1}if(we===!1){let i=document.createElement("style");i.textContent=e,t instanceof Document?t.head.prepend(i):t.prepend(i)}else t.adoptedStyleSheets=[we,...t.adoptedStyleSheets]}function _o(){if(typeof window>"u")return;window.ToggleEvent=window.ToggleEvent||et;function t(a){return a?.includes(":popover-open")&&(a=a.replace(So,"$1.\\:popover-open")),a}ce(Document.prototype,"querySelector",t),ce(Document.prototype,"querySelectorAll",t),ce(Element.prototype,"querySelector",t),ce(Element.prototype,"querySelectorAll",t),ce(Element.prototype,"matches",t),ce(Element.prototype,"closest",t),ce(DocumentFragment.prototype,"querySelectorAll",t),Object.defineProperties(HTMLElement.prototype,{popover:{enumerable:!0,configurable:!0,get(){if(!this.hasAttribute("popover"))return null;let a=(this.getAttribute("popover")||"").toLowerCase();return a===""||a=="auto"?"auto":"manual"},set(a){a===null?this.removeAttribute("popover"):this.setAttribute("popover",a)}},showPopover:{enumerable:!0,configurable:!0,value(){_t(this)}},hidePopover:{enumerable:!0,configurable:!0,value(){Re(this,!0,!0)}},togglePopover:{enumerable:!0,configurable:!0,value(a){De.get(this)==="showing"&&a===void 0||a===!1?Re(this,!0,!0):(a===void 0||a===!0)&&_t(this)}}});let e=Element.prototype.attachShadow;e&&Object.defineProperties(Element.prototype,{attachShadow:{enumerable:!0,configurable:!0,writable:!0,value(a){let l=e.call(this,a);return kt(l),l}}});let i=HTMLElement.prototype.attachInternals;i&&Object.defineProperties(HTMLElement.prototype,{attachInternals:{enumerable:!0,configurable:!0,writable:!0,value(){let a=i.call(this);return a.shadowRoot&&kt(a.shadowRoot),a}}});let o=new WeakMap;function n(a){Object.defineProperties(a.prototype,{popoverTargetElement:{enumerable:!0,configurable:!0,set(l){if(l===null)this.removeAttribute("popovertarget"),o.delete(this);else if(l instanceof Element)this.setAttribute("popovertarget",""),o.set(this,l);else throw new TypeError("popoverTargetElement must be an element or null")},get(){if(this.localName!=="button"&&this.localName!=="input"||this.localName==="input"&&this.type!=="reset"&&this.type!=="image"&&this.type!=="button"||this.disabled||this.form&&this.type==="submit")return null;let l=o.get(this);if(l&&l.isConnected)return l;if(l&&!l.isConnected)return o.delete(this),null;let h=ye(this),f=this.getAttribute("popovertarget");return(h instanceof Document||h instanceof pi)&&f&&h.getElementById(f)||null}},popoverTargetAction:{enumerable:!0,configurable:!0,get(){let l=(this.getAttribute("popovertargetaction")||"").toLowerCase();return l==="show"||l==="hide"?l:"toggle"},set(l){this.setAttribute("popovertargetaction",l)}}})}n(HTMLButtonElement),n(HTMLInputElement);let s=a=>{let l=a.composedPath(),h=l[0];if(!(h instanceof Element)||h?.shadowRoot)return;let f=ye(h);if(!(f instanceof pi||f instanceof Document))return;let b=l.find(m=>m.matches?.("[popovertargetaction],[popovertarget]"));if(b){bo(b),a.preventDefault();return}},r=a=>{let l=a.key,h=a.target;!a.defaultPrevented&&h&&(l==="Escape"||l==="Esc")&&tt(h.ownerDocument,!0,!0)};(a=>{a.addEventListener("click",s),a.addEventListener("keydown",r),a.addEventListener("pointerdown",hi),a.addEventListener("pointerup",hi)})(document),kt(document)}xo()||_o();var at=class extends Event{oldState;newState;constructor(t,{oldState:e="",newState:i="",...o}={}){super(t,o),this.oldState=String(e||""),this.newState=String(i||"")}},gi=new WeakMap;function xi(t,e,i){gi.set(t,setTimeout(()=>{gi.has(t)&&t.dispatchEvent(new at("toggle",{cancelable:!1,oldState:e,newState:i}))},0))}var Mt=globalThis.ShadowRoot||function(){},Co=globalThis.HTMLDialogElement||function(){},it=new WeakMap,U=new WeakMap,Ne=new WeakMap;function ot(t){return Ne.get(t)||"hidden"}var nt=new WeakMap;function Oo(t){let e=t.popoverTargetElement;if(!(e instanceof HTMLElement))return;let i=ot(e);t.popoverTargetAction==="show"&&i==="showing"||t.popoverTargetAction==="hide"&&i==="hidden"||(i==="showing"?Fe(e,!0,!0):he(e,!1)&&(nt.set(e,t),Lt(e)))}function he(t,e){return!(t.popover!=="auto"&&t.popover!=="manual"||!t.isConnected||e&&ot(t)!=="showing"||!e&&ot(t)!=="hidden"||t instanceof Co&&t.hasAttribute("open")||document.fullscreenElement===t)}function vi(t){return t?Array.from(U.get(t.ownerDocument)||[]).indexOf(t)+1:0}function To(t){let e=Si(t),i=Po(t);return vi(e)>vi(i)?e:i}function st(t){let e=U.get(t);for(let i of e||[])if(!i.isConnected)e.delete(i);else return i;return null}function xe(t){return typeof t.getRootNode=="function"?t.getRootNode():t.parentNode?xe(t.parentNode):t}function Si(t){for(;t;){if(t instanceof HTMLElement&&t.popover==="auto"&&Ne.get(t)==="showing")return t;if(t=t instanceof Element&&t.assignedSlot||t.parentElement||xe(t),t instanceof Mt&&(t=t.host),t instanceof Document)return}}function Po(t){for(;t;){let e=t.popoverTargetElement;if(e instanceof HTMLElement)return e;if(t=t.parentElement||xe(t),t instanceof Mt&&(t=t.host),t instanceof Document)return}}function Lo(t){let e=new Map,i=0;for(let s of U.get(t.ownerDocument)||[])e.set(s,i),i+=1;e.set(t,i),i+=1;let o=null;function n(s){let r=Si(s);if(r===null)return null;let c=e.get(r);(o===null||e.get(o)<c)&&(o=r)}return n(t.parentElement||xe(t)),o}function Mo(t){return t.hidden||t instanceof Mt||(t instanceof HTMLButtonElement||t instanceof HTMLInputElement||t instanceof HTMLSelectElement||t instanceof HTMLTextAreaElement||t instanceof HTMLOptGroupElement||t instanceof HTMLOptionElement||t instanceof HTMLFieldSetElement)&&t.disabled||t instanceof HTMLInputElement&&t.type==="hidden"||t instanceof HTMLAnchorElement&&t.href===""?!1:typeof t.tabIndex=="number"&&t.tabIndex!==-1}function Ro(t){if(t.shadowRoot&&t.shadowRoot.delegatesFocus!==!0)return null;let e=t;e.shadowRoot&&(e=e.shadowRoot);let i=e.querySelector("[autofocus]");if(i)return i;{let s=e.querySelectorAll("slot");for(let r of s){let c=r.assignedElements({flatten:!0});for(let a of c){if(a.hasAttribute("autofocus"))return a;if(i=a.querySelector("[autofocus]"),i)return i}}}let o=t.ownerDocument.createTreeWalker(e,NodeFilter.SHOW_ELEMENT),n=o.currentNode;for(;n;){if(Mo(n))return n;n=o.nextNode()}}function Do(t){Ro(t)?.focus()}var rt=new WeakMap;function Lt(t){if(!he(t,!1))return;let e=t.ownerDocument;if(!t.dispatchEvent(new at("beforetoggle",{cancelable:!0,oldState:"closed",newState:"open"}))||!he(t,!1))return;let i=!1;if(t.popover==="auto"){let n=t.getAttribute("popover"),s=Lo(t)||e;if(lt(s,!1,!0),n!==t.getAttribute("popover")||!he(t,!1))return}st(e)||(i=!0),rt.delete(t);let o=e.activeElement;t.classList.add(":popover-open"),Ne.set(t,"showing"),it.has(e)||it.set(e,new Set),it.get(e).add(t),Do(t),t.popover==="auto"&&(U.has(e)||U.set(e,new Set),U.get(e).add(t),Ei(nt.get(t),!0)),i&&o&&t.popover==="auto"&&rt.set(t,o),xi(t,"closed","open")}function Fe(t,e=!1,i=!1){if(!he(t,!0))return;let o=t.ownerDocument;if(t.popover==="auto"&&(lt(t,e,i),!he(t,!0))||(Ei(nt.get(t),!1),nt.delete(t),i&&(t.dispatchEvent(new at("beforetoggle",{oldState:"open",newState:"closed"})),!he(t,!0))))return;it.get(o)?.delete(t),U.get(o)?.delete(t),t.classList.remove(":popover-open"),Ne.set(t,"hidden"),i&&xi(t,"open","closed");let n=rt.get(t);n&&(rt.delete(t),e&&n.focus())}function wi(t,e=!1,i=!1){let o=st(t);for(;o;)Fe(o,e,i),o=st(t)}function lt(t,e,i){let o=t.ownerDocument||t;if(t instanceof Document)return wi(o,e,i);let n=null,s=!1;for(let r of U.get(o)||[])if(r===t)s=!0;else if(s){n=r;break}if(!s)return wi(o,e,i);for(;n&&ot(n)==="showing"&&U.get(o)?.size;)Fe(n,e,i)}var Ot=new WeakMap;function yi(t){if(!t.isTrusted)return;let e=t.composedPath()[0];if(!e)return;let i=e.ownerDocument;if(!st(i))return;let n=To(e);if(n&&t.type==="pointerdown")Ot.set(i,n);else if(t.type==="pointerup"){let s=Ot.get(i)===n;Ot.delete(i),s&&lt(n||i,!1,!0)}}var Tt=new WeakMap;function Ei(t,e=!1){if(!t)return;Tt.has(t)||Tt.set(t,t.getAttribute("aria-expanded"));let i=t.popoverTargetElement;if(i instanceof HTMLElement&&i.popover==="auto")t.setAttribute("aria-expanded",String(e));else{let o=Tt.get(t);o?t.setAttribute("aria-expanded",o):t.removeAttribute("aria-expanded")}}var Ai=globalThis.ShadowRoot||function(){};function ki(){return typeof HTMLElement<"u"&&typeof HTMLElement.prototype=="object"&&"popover"in HTMLElement.prototype}function _i(){return!!(document.body?.showPopover&&!/native code/i.test(document.body.showPopover.toString()))}function fe(t,e,i){let o=t[e];Object.defineProperty(t,e,{value(n){return o.call(this,i(n))}})}var Fo=/(^|[^\\]):popover-open\b/g;function No(){return typeof globalThis.CSSLayerBlockRule=="function"}function Io(){let t=No();return`
${t?"@layer popover-polyfill {":""}
  :where([popover]) {
    position: fixed;
    z-index: 2147483647;
