(()=>{var ht=class extends Event{oldState;newState;constructor(t,{oldState:e="",newState:i="",...s}={}){super(t,s),this.oldState=String(e||""),this.newState=String(i||"")}},$i=new WeakMap;function Gi(t,e,i){$i.set(t,setTimeout(()=>{$i.has(t)&&t.dispatchEvent(new ht("toggle",{cancelable:!1,oldState:e,newState:i}))},0))}var $t=globalThis.ShadowRoot||function(){},Gs=globalThis.HTMLDialogElement||function(){},rt=new WeakMap,ee=new WeakMap,$e=new WeakMap;function lt(t){return $e.get(t)||"hidden"}var at=new WeakMap;function Ys(t){let e=t.popoverTargetElement;if(!(e instanceof HTMLElement))return;let i=lt(e);t.popoverTargetAction==="show"&&i==="showing"||t.popoverTargetAction==="hide"&&i==="hidden"||(i==="showing"?qe(e,!0,!0):be(e,!1)&&(at.set(e,t),qt(e)))}function be(t,e){return!(t.popover!=="auto"&&t.popover!=="manual"||!t.isConnected||e&&lt(t)!=="showing"||!e&&lt(t)!=="hidden"||t instanceof Gs&&t.hasAttribute("open")||document.fullscreenElement===t)}function zi(t){return t?Array.from(ee.get(t.ownerDocument)||[]).indexOf(t)+1:0}function Xs(t){let e=Yi(t),i=Js(t);return zi(e)>zi(i)?e:i}function ut(t){let e=ee.get(t);for(let i of e||[])if(!i.isConnected)e.delete(i);else return i;return null}function Ce(t){return typeof t.getRootNode=="function"?t.getRootNode():t.parentNode?Ce(t.parentNode):t}function Yi(t){for(;t;){if(t instanceof HTMLElement&&t.popover==="auto"&&$e.get(t)==="showing")return t;if(t=t instanceof Element&&t.assignedSlot||t.parentElement||Ce(t),t instanceof $t&&(t=t.host),t instanceof Document)return}}function Js(t){for(;t;){let e=t.popoverTargetElement;if(e instanceof HTMLElement)return e;if(t=t.parentElement||Ce(t),t instanceof $t&&(t=t.host),t instanceof Document)return}}function Qs(t){let e=new Map,i=0;for(let n of ee.get(t.ownerDocument)||[])e.set(n,i),i+=1;e.set(t,i),i+=1;let s=null;function o(n){let r=Yi(n);if(r===null)return null;let u=e.get(r);(s===null||e.get(s)<u)&&(s=r)}return o(t.parentElement||Ce(t)),s}function Zs(t){return t.hidden||t instanceof $t||(t instanceof HTMLButtonElement||t instanceof HTMLInputElement||t instanceof HTMLSelectElement||t instanceof HTMLTextAreaElement||t instanceof HTMLOptGroupElement||t instanceof HTMLOptionElement||t instanceof HTMLFieldSetElement)&&t.disabled||t instanceof HTMLInputElement&&t.type==="hidden"||t instanceof HTMLAnchorElement&&t.href===""?!1:typeof t.tabIndex=="number"&&t.tabIndex!==-1}function eo(t){if(t.shadowRoot&&t.shadowRoot.delegatesFocus!==!0)return null;let e=t;e.shadowRoot&&(e=e.shadowRoot);let i=e.querySelector("[autofocus]");if(i)return i;{let n=e.querySelectorAll("slot");for(let r of n){let u=r.assignedElements({flatten:!0});for(let l of u){if(l.hasAttribute("autofocus"))return l;if(i=l.querySelector("[autofocus]"),i)return i}}}let s=t.ownerDocument.createTreeWalker(e,NodeFilter.SHOW_ELEMENT),o=s.currentNode;for(;o;){if(Zs(o))return o;o=s.nextNode()}}function to(t){eo(t)?.focus()}var ct=new WeakMap;function qt(t){if(!be(t,!1))return;let e=t.ownerDocument;if(!t.dispatchEvent(new ht("beforetoggle",{cancelable:!0,oldState:"closed",newState:"open"}))||!be(t,!1))return;let i=!1;if(t.popover==="auto"){let o=t.getAttribute("popover"),n=Qs(t)||e;if(dt(n,!1,!0),o!==t.getAttribute("popover")||!be(t,!1))return}ut(e)||(i=!0),ct.delete(t);let s=e.activeElement;t.classList.add(":popover-open"),$e.set(t,"showing"),rt.has(e)||rt.set(e,new Set),rt.get(e).add(t),to(t),t.popover==="auto"&&(ee.has(e)||ee.set(e,new Set),ee.get(e).add(t),Xi(at.get(t),!0)),i&&s&&t.popover==="auto"&&ct.set(t,s),Gi(t,"closed","open")}function qe(t,e=!1,i=!1){if(!be(t,!0))return;let s=t.ownerDocument;if(t.popover==="auto"&&(dt(t,e,i),!be(t,!0))||(Xi(at.get(t),!1),at.delete(t),i&&(t.dispatchEvent(new ht("beforetoggle",{oldState:"open",newState:"closed"})),!be(t,!0))))return;rt.get(s)?.delete(t),ee.get(s)?.delete(t),t.classList.remove(":popover-open"),$e.set(t,"hidden"),i&&Gi(t,"open","closed");let o=ct.get(t);o&&(ct.delete(t),e&&o.focus())}function ji(t,e=!1,i=!1){let s=ut(t);for(;s;)qe(s,e,i),s=ut(t)}function dt(t,e,i){let s=t.ownerDocument||t;if(t instanceof Document)return ji(s,e,i);let o=null,n=!1;for(let r of ee.get(s)||[])if(r===t)n=!0;else if(n){o=r;break}if(!n)return ji(s,e,i);for(;o&&lt(o)==="showing"&&ee.get(s)?.size;)qe(o,e,i)}var Wt=new WeakMap;function Ki(t){if(!t.isTrusted)return;let e=t.composedPath()[0];if(!e)return;let i=e.ownerDocument;if(!ut(i))return;let o=Xs(e);if(o&&t.type==="pointerdown")Wt.set(i,o);else if(t.type==="pointerup"){let n=Wt.get(i)===o;Wt.delete(i),n&&dt(o||i,!1,!0)}}var Vt=new WeakMap;function Xi(t,e=!1){if(!t)return;Vt.has(t)||Vt.set(t,t.getAttribute("aria-expanded"));let i=t.popoverTargetElement;if(i instanceof HTMLElement&&i.popover==="auto")t.setAttribute("aria-expanded",String(e));else{let s=Vt.get(t);s?t.setAttribute("aria-expanded",s):t.removeAttribute("aria-expanded")}}var Ui=globalThis.ShadowRoot||function(){};function io(){return typeof HTMLElement<"u"&&typeof HTMLElement.prototype=="object"&&"popover"in HTMLElement.prototype}function pe(t,e,i){let s=t[e];Object.defineProperty(t,e,{value(o){return s.call(this,i(o))}})}var so=/(^|[^\\]):popover-open\b/g;function oo(){return typeof globalThis.CSSLayerBlockRule=="function"}function no(){let t=oo();return`
...
${t?"}":""}
`}var ke=null;function Bt(t){let e=no();if(ke===null)try{ke=new CSSStyleSheet,ke.replaceSync(e)}catch{ke=!1}if(ke===!1){let i=document.createElement("style");i.textContent=e,t instanceof Document?t.head.prepend(i):t.prepend(i)}else t.adoptedStyleSheets=[ke,...t.adoptedStyleSheets]}function ro(){if(typeof window>"u")return;window.ToggleEvent=window.ToggleEvent||ht;function t(l){return l?.includes(":popover-open")&&(l=l.replace(so,"$1.\\:popover-open")),l}pe(Document.prototype,"querySelector",t),pe(Document.prototype,"querySelectorAll",t),pe(Element.prototype,"querySelector",t),pe(Element.prototype,"querySelectorAll",t),pe(Element.prototype,"matches",t),pe(Element.prototype,"closest",t),pe(DocumentFragment.prototype,"querySelectorAll",t),Object.defineProperties(HTMLElement.prototype,{popover:{enumerable:!0,configurable:!0,get(){if(!this.hasAttribute("popover"))return null;let l=(this.getAttribute("popover")||"").toLowerCase();return l===""||l=="auto"?"auto":"manual"},set(l){l===null?this.removeAttribute("popover"):this.setAttribute("popover",l)}},showPopover:{enumerable:!0,configurable:!0,value(){qt(this)}},hidePopover:{enumerable:!0,configurable:!0,value(){qe(this,!0,!0)}},togglePopover:{enumerable:!0,configurable:!0,value(l){$e.get(this)==="showing"&&l===void 0||l===!1?qe(this,!0,!0):(l===void 0||l===!0)&&qt(this)}}});let e=Element.prototype.attachShadow;e&&Object.defineProperties(Element.prototype,{attachShadow:{enumerable:!0,configurable:!0,writable:!0,value(l){let a=e.call(this,l);return Bt(a),a}}});let i=HTMLElement.prototype.attachInternals;i&&Object.defineProperties(HTMLElement.prototype,{attachInternals:{enumerable:!0,configurable:!0,writable:!0,value(){let l=i.call(this);return l.shadowRoot&&Bt(l.shadowRoot),l}}});let s=new WeakMap;function o(l){Object.defineProperties(l.prototype,{popoverTargetElement:{enumerable:!0,configurable:!0,set(a){if(a===null)this.removeAttribute("popovertarget"),s.delete(this);else if(a instanceof Element)this.setAttribute("popovertarget",""),s.set(this,a);else throw new TypeError("popoverTargetElement must be an element or null")},get(){if(this.localName!=="button"&&this.localName!=="input"||this.localName==="input"&&this.type!=="reset"&&this.type!=="image"&&this.type!=="button"||this.disabled||this.form&&this.type==="submit")return null;let a=s.get(this);if(a&&a.isConnected)return a;if(a&&!a.isConnected)return s.delete(this),null;let f=Ce(this),d=this.getAttribute("popovertarget");return(f instanceof Document||f instanceof Ui)&&d&&f.getElementById(d)||null}},popoverTargetAction:{enumerable:!0,configurable:!0,get(){let a=(this.getAttribute("popovertargetaction")||"").toLowerCase();return a==="show"||a==="hide"?a:"toggle"},set(a){this.setAttribute("popovertargetaction",a)}}})}o(HTMLButtonElement),o(HTMLInputElement);let n=l=>{let a=l.composedPath(),f=a[0];if(!(f instanceof Element)||f?.shadowRoot)return;let d=Ce(f);if(!(d instanceof Ui||d instanceof Document))return;let m=a.find(g=>g.matches?.("[popovertargetaction],[popovertarget]"));if(m){Ys(m),l.preventDefault();return}},r=l=>{let a=l.key,f=l.target;!l.defaultPrevented&&f&&(a==="Escape"||a==="Esc")&&dt(f.ownerDocument,!0,!0)};(l=>{l.addEventListener("click",n),l.addEventListener("keydown",r),l.addEventListener("pointerdown",Ki),l.addEventListener("pointerup",Ki)})(document),Bt(document)}io()||ro();var vt=class extends Event{oldState;newState;constructor(t,{oldState:e="",newState:i="",...s}={}){super(t,s),this.oldState=String(e||""),this.newState=String(i||"")}},Ji=new WeakMap;function is(t,e,i){Ji.set(t,setTimeout(()=>{Ji.has(t)&&t.dispatchEvent(new vt("toggle",{cancelable:!1,oldState:e,newState:i}))},0))}var Gt=globalThis.ShadowRoot||function(){},lo=globalThis.HTMLDialogElement||function(){},ft=new WeakMap,te=new WeakMap,je=new WeakMap;function pt(t){return je.get(t)||"hidden"}var bt=new WeakMap;function ao(t){let e=t.popoverTargetElement;if(!(e instanceof HTMLElement))return;let i=pt(e);t.popoverTargetAction==="show"&&i==="showing"||t.popoverTargetAction==="hide"&&i==="hidden"||(i==="showing"?ze(e,!0,!0):ge(e,!1)&&(bt.set(e,t),Ut(e)))}function ge(t,e){return!(t.popover!=="auto"&&t.popover!=="manual"||!t.isConnected||e&&pt(t)!=="showing"||!e&&pt(t)!=="hidden"||t instanceof lo&&t.hasAttribute("open")||document.fullscreenElement===t)}function Qi(t){return t?Array.from(te.get(t.ownerDocument)||[]).indexOf(t)+1:0}function uo(t){let e=ss(t),i=co(t);return Qi(e)>Qi(i)?e:i}function mt(t){let e=te.get(t);for(let i of e||[])if(!i.isConnected)e.delete(i);else return i;return null}function Oe(t){return typeof t.getRootNode=="function"?t.getRootNode():t.parentNode?Oe(t.parentNode):t}function ss(t){for(;t;){if(t instanceof HTMLElement&&t.popover==="auto"&&je.get(t)==="showing")return t;if(t=t instanceof Element&&t.assignedSlot||t.parentElement||Oe(t),t instanceof Gt&&(t=t.host),t instanceof Document)return}}function co(t){for(;t;){let e=t.popoverTargetElement;if(e instanceof HTMLElement)return e;if(t=t.parentElement||Oe(t),t instanceof Gt&&(t=t.host),t instanceof Document)return}}function ho(t){let e=new Map,i=0;for(let n of te.get(t.ownerDocument)||[])e.set(n,i),i+=1;e.set(t,i),i+=1;let s=null;function o(n){let r=ss(n);if(r===null)return null;let u=e.get(r);(s===null||e.get(s)<u)&&(s=r)}return o(t.parentElement||Oe(t)),s}function fo(t){return t.hidden||t instanceof Gt||(t instanceof HTMLButtonElement||t instanceof HTMLInputElement||t instanceof HTMLSelectElement||t instanceof HTMLTextAreaElement||t instanceof HTMLOptGroupElement||t instanceof HTMLOptionElement||t instanceof HTMLFieldSetElement)&&t.disabled||t instanceof HTMLInputElement&&t.type==="hidden"||t instanceof HTMLAnchorElement&&t.href===""?!1:typeof t.tabIndex=="number"&&t.tabIndex!==-1}function po(t){if(t.shadowRoot&&t.shadowRoot.delegatesFocus!==!0)return null;let e=t;e.shadowRoot&&(e=e.shadowRoot);let i=e.querySelector("[autofocus]");if(i)return i;{let n=e.querySelectorAll("slot");for(let r of n){let u=r.assignedElements({flatten:!0});for(let l of u){if(l.hasAttribute("autofocus"))return l;if(i=l.querySelector("[autofocus]"),i)return i}}}let s=t.ownerDocument.createTreeWalker(e,NodeFilter.SHOW_ELEMENT),o=s.currentNode;for(;o;){if(fo(o))return o;o=s.nextNode()}}function bo(t){po(t)?.focus()}var gt=new WeakMap;function Ut(t){if(!ge(t,!1))return;let e=t.ownerDocument;if(!t.dispatchEvent(new vt("beforetoggle",{cancelable:!0,oldState:"closed",newState:"open"}))||!ge(t,!1))return;let i=!1;if(t.popover==="auto"){let o=t.getAttribute("popover"),n=ho(t)||e;if(wt(n,!1,!0),o!==t.getAttribute("popover")||!ge(t,!1))return}mt(e)||(i=!0),gt.delete(t);let s=e.activeElement;t.classList.add(":popover-open"),je.set(t,"showing"),ft.has(e)||ft.set(e,new Set),ft.get(e).add(t),bo(t),t.popover==="auto"&&(te.has(e)||te.set(e,new Set),te.get(e).add(t),os(bt.get(t),!0)),i&&s&&t.popover==="auto"&&gt.set(t,s),is(t,"closed","open")}function ze(t,e=!1,i=!1){if(!ge(t,!0))return;let s=t.ownerDocument;if(t.popover==="auto"&&(wt(t,e,i),!ge(t,!0))||(os(bt.get(t),!1),bt.delete(t),i&&(t.dispatchEvent(new vt("beforetoggle",{oldState:"open",newState:"closed"})),!ge(t,!0))))return;ft.get(s)?.delete(t),te.get(s)?.delete(t),t.classList.remove(":popover-open"),je.set(t,"hidden"),i&&is(t,"open","closed");let o=gt.get(t);o&&(gt.delete(t),e&&o.focus())}function Zi(t,e=!1,i=!1){let s=mt(t);for(;s;)ze(s,e,i),s=mt(t)}function wt(t,e,i){let s=t.ownerDocument||t;if(t instanceof Document)return Zi(s,e,i);let o=null,n=!1;for(let r of te.get(s)||[])if(r===t)n=!0;else if(n){o=r;break}if(!n)return Zi(s,e,i);for(;o&&pt(o)==="showing"&&te.get(s)?.size;)ze(o,e,i)}var zt=new WeakMap;function es(t){if(!t.isTrusted)return;let e=t.composedPath()[0];if(!e)return;let i=e.ownerDocument;if(!mt(i))return;let o=uo(e);if(o&&t.type==="pointerdown")zt.set(i,o);else if(t.type==="pointerup"){let n=zt.get(i)===o;zt.delete(i),n&&wt(o||i,!1,!0)}}var jt=new WeakMap;function os(t,e=!1){if(!t)return;jt.has(t)||jt.set(t,t.getAttribute("aria-expanded"));let i=t.popoverTargetElement;if(i instanceof HTMLElement&&i.popover==="auto")t.setAttribute("aria-expanded",String(e));else{let s=jt.get(t);s?t.setAttribute("aria-expanded",s):t.removeAttribute("aria-expanded")}}var ts=globalThis.ShadowRoot||function(){};function ns(){return typeof HTMLElement<"u"&&typeof HTMLElement.prototype=="object"&&"popover"in HTMLElement.prototype}function rs(){return!!(document.body?.showPopover&&!/native code/i.test(document.body.showPopover.toString()))}function me(t,e,i){let s=t[e];Object.defineProperty(t,e,{value(o){return s.call(this,i(o))}})}var mo=/(^|[^\\]):popover-open\b/g;function go(){return typeof globalThis.CSSLayerBlockRule=="function"}function vo(){let t=go();return`
${t?"@layer popover-polyfill {":""}
  :where([popover]) {
    position: fixed;
    z-index: 2147483647;
