...
<svg {{ $attributes->class($classes) }}
    ...
    <path d="M13.531,12.906h4.937v5.172c0,1.74-2.149,.382-2.469,1.328-.293-.945-2.456,.425-2.456-1.431,0-1.805-.013-5.069-.013-5.069Z"
          fill="#dcdcdc"></path>
    <path d="M11,16L2.074,5.289c-.661,.714-1.074,1.661-1.074,2.711V24c0,1.05,.413,1.997,1.074,2.711l8.926-10.711Z"
          fill="#3272c9"></path>
