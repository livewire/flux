...
<svg {{ $attributes->class($classes) }} data-flux-flag xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" data-slot="flag">
    ...
    <path d="M5,22H27c2.208,0,4,1.792,4,4v2H1v-2c0-2.208,1.792-4,4-4Z" transform="rotate(180 16 25)" fill="#f8d147"></path>
    <path fill="#f8d147" d="M7.575 7.472L8.875 6.528 7.269 6.528 6.772 5 6.276 6.528 4.669 6.528 5.969 7.472 5.472 9 6.772 8.056 8.072 9 7.575 7.472z"></path>
