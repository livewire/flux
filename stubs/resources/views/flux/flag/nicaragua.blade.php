...
<svg {{ $attributes->class($classes) }}
    ...
    <path d="M5,4H27c2.208,0,4,1.792,4,4v4H1v-4c0-2.208,1.792-4,4-4Z" fill="#2b66c1"></path>
    ...
    <path d="M27,5H5c-1.657,0-3,1.343-3,3v1c0-1.657,1.343-3,3-3H27c1.657,0,3,1.343,3,3v-1c0-1.657-1.343-3-3-3Z"
          fill="#fff"
          opacity=".2"></path>
    <path d="M18.992 18.367L13.008 18.367 16 13.185 18.992 18.367z" fill="#c1a436"></path>
</svg>
