...
<svg {{ $attributes->class($classes) }}
    ...
    <path d="M27,4H5c-2.209,0-4,1.791-4,4V24c0,2.209,1.791,4,4,4H27c2.209,0,4-1.791,4-4V8c0-2.209-1.791-4-4-4Zm3,20c0,1.654-1.346,3-3,3H5c-1.654,0-3-1.346-3-3V8c0-1.654,1.346-3,3-3H27c1.654,0,3,1.346,3,3V24Z"
          opacity=".15"></path>
    <path d="M16.001,22h0c2.524,0,4.59-2.065,4.59-4.59v-5.454H11.412v5.454c0,2.524,2.065,4.59,4.59,4.59h0Z"
          fill="#ea3323"></path>
    <path d="M16.001,21.926h0c2.476,0,4.502-2.026,4.502-4.502v-5.38H11.499v5.38c0,2.476,2.026,4.502,4.502,4.502Z"
          fill="#fff"></path>
    ...
    <path d="M16.3,21.732c.192-.013,.38-.039,.565-.077v-1.827h-1.733v1.827c.184,.038,.372,.063,.563,.077,.202,.012,.404,.012,.605,0h0Z"
          fill="#ea3323"></path>
    ...
    <path d="M20.426,11.9l1.074-2.435-.818-1.322-1.356,.502-.952-1.088-1.255,.719-1.119-.916-1.119,.916-1.255-.719-.952,1.088-1.356-.502-.819,1.322,1.073,2.436c1.352-.612,2.851-.953,4.427-.953s3.074,.341,4.426,.952h0Z"
          fill="#fff"></path>
    <path d="M12.705,8.753l-.002,.002-1.345-.498-.753,1.215,.288,.655,.73,1.658c.545-.241,1.114-.439,1.701-.588l-.62-2.444h0Z"
          fill="#0093dd"></path>
    <path d="M14.893,8.387l-.002,.002-1.244-.713-.942,1.077,.62,2.444c.576-.147,1.169-.247,1.777-.297l-.208-2.513h0Z"
          fill="#100e91"></path>
    <path d="M17.112,8.388l-.003,.002-1.109-.908-1.107,.907,.208,2.513c.296-.024,.596-.038,.899-.038s.605,.013,.903,.038l.209-2.513h0Z"
          fill="#0093dd"></path>
    <path d="M19.3,8.754h-.003s-.944-1.078-.944-1.078l-1.241,.711-.209,2.513c.608,.05,1.201,.151,1.777,.297l.621-2.444h0Z"
          fill="#100e91"></path>
    <path d="M20.375,11.785l1.02-2.312-.753-1.215-1.342,.497-.621,2.444c.585,.149,1.152,.347,1.695,.587h0Z"
          fill="#0093dd"></path>
