...
<svg {{ $attributes->class($classes) }}
    ...
    <path d="M10 4H22V28H10z" fill="#fbf064"></path>
    <path d="M5,4h6V28H5c-2.208,0-4-1.792-4-4V8c0-2.208,1.792-4,4-4Z" fill="#3a8445"></path>
    ...
    <path d="M27,4H5c-2.209,0-4,1.791-4,4V24c0,2.209,1.791,4,4,4H27c2.209,0,4-1.791,4-4V8c0-2.209-1.791-4-4-4Zm3,20c0,1.654-1.346,3-3,3H5c-1.654,0-3-1.346-3-3V8c0-1.654,1.346-3,3-3H27c1.654,0,3,1.346,3,3V24Z"
          opacity=".15"></path>
    <path d="M17.516 16.391L19.969 14.609 16.937 14.609 16 11.725 15.063 14.609 12.031 14.609 14.484 16.391 13.547 19.275 16 17.492 18.453 19.275 17.516 16.391z"
          fill="#3a8445"></path>
