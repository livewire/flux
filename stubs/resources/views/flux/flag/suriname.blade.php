...
<svg {{ $attributes->class($classes) }}
    ...
    <path d="M1 8H31V24H1z" fill="#a6222f"></path>
    ...
    <path d="M27,5H5c-1.657,0-3,1.343-3,3v1c0-1.657,1.343-3,3-3H27c1.657,0,3,1.343,3,3v-1c0-1.657-1.343-3-3-3Z"
          fill="#fff"
          opacity=".2"></path>
    <path d="M18.008 17.18L21.257 14.82 17.241 14.82 16 11 14.759 14.82 10.743 14.82 13.992 17.18 12.751 21 16 18.639 19.249 21 18.008 17.18z"
          fill="#e7cb48"></path>
</svg>
