...
<svg {{ $attributes->class($classes) }}
    ...
    <path d="M4 13L5 16 4 19 3 16 4 13z" fill="#fff"></path>
    <path d="M2.5 8L3.5 11 2.5 14 1.5 11 2.5 8z" fill="#fff"></path>
    <path d="M5.5 8L6.5 11 5.5 14 4.5 11 5.5 8z" fill="#fff"></path>
    <path d="M2.5 18L3.5 21 2.5 24 1.5 21 2.5 18z" fill="#fff"></path>
    <path d="M5.5 18L6.5 21 5.5 24 4.5 21 5.5 18z" fill="#fff"></path>
    <path d="M1 13L1 19 2 16 1 13z" fill="#fff"></path>
    <path d="M7 13L6 16 7 19 7 13z" fill="#fff"></path>
    ...
    <path d="M6.667 4L6 6 7 9 7 4 6.667 4z" fill="#fff"></path>
    ...
    <path d="M6.667 28L6 26 7 23 7 28 6.667 28z" fill="#fff"></path>
