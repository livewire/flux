...
<svg {{ $attributes->class($classes) }} data-flux-flag xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" data-slot="flag">
    ...
    <polygon points="11.3742 14.0242 13.0369 12.8443 10.9809 12.8443 10.3115 10.8361 9.6421 12.8443 7.5861 12.8443 9.2488 14.0242 8.5902 16 10.3115 14.7784 12.0328 16 11.3742 14.0242" fill="#fff" stroke-width="0"></polygon>
    <polygon points="6.8095 9.6539 8.0881 8.7561 6.5102 8.7561 6.0082 7.25 5.5251 8.7561 4 8.7561 5.2398 9.6456 4.7889 11.0512 4.7172 11.123 6.0221 10.2068 7.2992 11.123 6.8095 9.6539" fill="#fff" stroke-width="0"></polygon>
</svg>
