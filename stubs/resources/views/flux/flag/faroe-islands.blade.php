...
<svg {{ $attributes->class($classes) }}
    ...
    <rect fill="#fff"
          ...
          x="1"
          y="4"></rect>
    <path d="M31 12L17 12 17 4 9 4 9 12 1 12 1 20 9 20 9 28 17 28 17 20 31 20 31 12z" fill="#285cb3"></path>
    <path d="M31 14L15 14 15 4 11 4 11 14 1 14 1 18 11 18 11 28 15 28 15 18 31 18 31 14z" fill="#dd4446"></path>
