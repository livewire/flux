...
<svg {{ $attributes->class($classes) }}
    ...
    <path d="M5,4H27c2.208,0,4,1.792,4,4v2H1v-2c0-2.208,1.792-4,4-4Z" fill="#db2f20"></path>
    <path d="M5,22H27c2.208,0,4,1.792,4,4v2H1v-2c0-2.208,1.792-4,4-4Z"
          fill="#db2f20"
          transform="rotate(180 16 25)"></path>
    <path d="M1 18H31V23H1z" fill="#fff"></path>
    <path d="M1 9H31V14H1z" fill="#fff"></path>
    <path d="M1 13.5H31V18.5H1z" fill="#db2f20"></path>
