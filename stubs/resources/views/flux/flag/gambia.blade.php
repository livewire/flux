...
<svg {{ $attributes->class($classes) }}
    ...
    <path d="M1 13H31V19H1z" fill="#0a1488"></path>
    <path d="M5,4H27c2.208,0,4,1.792,4,4v6H1v-6c0-2.208,1.792-4,4-4Z" fill="#be2a2c"></path>
    <path d="M5,18H27c2.208,0,4,1.792,4,4v6H1v-6c0-2.208,1.792-4,4-4Z"
          fill="#487730"
          transform="rotate(180 16 23)"></path>
    <path d="M1 12H31V14H1z" fill="#fff"></path>
    <path d="M1 18H31V20H1z" fill="#fff"></path>
